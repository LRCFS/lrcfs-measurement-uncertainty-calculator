tabCalibrationCurve = tabItem(tabName = "calibrationCurve",
                 fluidRow(
                   valueBox("Calculating the Uncertainty of Calibration Curve", h2(textOutput("uncertaintyOfCalibrationCurve")), width = 12, color = "blue", icon = icon("vials"))
                 ),
                 fluidRow(
                   box(title="Specify Parameters",
                       column(6,
                              numericInput("inputCaseSampleReplicates", 
                                           h5("Number of Case Sample Replicates"), 
                                           value = 2)
                       ),
                       column(6,
                              numericInput("inputCaseSampleMeanConcentration", 
                                           h5("Mean Concentration of Case Sample"), 
                                           value = 2)
                       ),
                       column(12,
                       h5("Upload Calibration Data (XLSX)"),
                 ...
                 fluidRow(
                   box(title="Uploaded Calibration Data", width = 12,
