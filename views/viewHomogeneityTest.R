                         ...
                         fluidRow(
                           column(width=6,
                             box(title = "Overview", width=12,
                                 ...
                                 p("\\(H_1\\): \\(m_l \\neq m_j\\) for some \\(l,j\\)"),
                                 p("The test statistic under \\(H_0\\) follows an F-distribution \\((F_{\\large s})\\) given by the ratio of mean sum of squares between \\((MSS_B)\\) and mean sum of squares within \\((MSS_W)\\), as shown in the Method tab."),
