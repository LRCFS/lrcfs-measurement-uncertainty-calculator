                         ...
                         fluidRow(
                           column(width=6,
                             box(title = "Overview", width=12,
                                 ...
                                 p(HTML("The \\(H_0\\) is rejected if the F statistic \\((F_{\\large s})\\) is greater than the F critical (\\(F_c\\)) value for a given alpha level and conclude that at least two group means differ. For more information see <a href='https://link.springer.com/article/10.1007/s007690000237' target='_blank'>Veen et al: Principles of analysis of variance (2000)</a> and <a href='https://link.springer.com/article/10.1007/s007690000238' target='_blank'>Veen et al: Homogeneity study (2001)</a>")),
