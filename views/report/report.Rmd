...
``` 
```{r part_homogeneity_noData, echo=FALSE, results='asis', eval=is.na(params$uncHomogeneity)}
cat("
## Homogeneity

No result recorded. Using NA.
")
```
...
```
```{r part_calibrationCurve_noData, echo=FALSE, results='asis', eval=is.na(params$uncCalibrationCurve)}
cat("
## Calibration Curve
...
```
```{r part_methodPrecision_noData, echo=FALSE, results='asis', eval=is.na(params$uncMethodPrecision)}
cat("
## Method Precision
...
```
```{r part_calibrationStandard_noData, echo=FALSE, results='asis', eval=is.na(params$uncStandardSolution)}
cat("
...
```
```{r part_samplePreparation_noData, echo=FALSE, results='asis', eval=is.na(params$uncSamplePreparation)}
cat("
## Sample Preparation
