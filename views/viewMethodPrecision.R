...
tabMethodPrecision = tabItem(tabName = "methodPrecision",
                            ...
                            fluidRow(
                              box(width=12,
                                  ...
                                  hr(),
                                  box(title="Sum of Degrees of Freedom \\(({\\large\\nu}_\\text{(NV)})\\)", width = 4, class="calcOverflow",
                                      uiOutput("outputSumOfDof")),
                                  box(title="Mean Concentration of \\(\\text{NV}\\) \\((\\overline{x}_\\text{(NV)})\\)", width = 4, class="calcOverflow",
                                      uiOutput("outputMeanConcForNv")),
                                  box(title="Sum of \\((S^2 \\times {\\large\\nu})_\\text{(NV)}\\)", width = 4, class="calcOverflow",
                                      uiOutput("outputSumOfS2d")),
                                  box(title="Pooled Standard Deviation \\((S_p)\\)", width = 4, class="calcOverflow",
                                      uiOutput("outputPooledStandardDeviation")),
                                  box(title="Standard Uncertainty \\((u)\\)", width = 4, class="calcOverflow",
                                      uiOutput("outputStandardUncertainty")),
                                  box(title="Realtive Standard Uncertainty \\((u_r)\\)", width = 4, class="calcOverflow",
