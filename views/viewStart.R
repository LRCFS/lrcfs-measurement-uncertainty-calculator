                            ...
                            fluidRow(
                              box(width=12, id="fileUploadBox",
                                  ...
                                  div(id="homogeneity",
                                      ...
                                      h4("Homogeneity"),
                                      a("Download Example Homogeneity CSV", href="exampleData/exampleData-homogeneity.csv", target="_blank"),
                                  ...
                                  div(id="calcurve",
                                    ...
                                    a("Download Example Calibration Curve CSV", href="exampleData/exampleData-calibrationCurve.csv", target="_blank"),
                                    ...
                                    a("Download Pooled Standard Error CSV", href="exampleData/exampleData-calibrationCurve-pooledStandardError.csv", target="_blank"),
                                  ...
                                  div(id="methodprec",
                                    ...
                                    h4("Method Precision"),
                                    a("Download Example Method Precision CSV", href="exampleData/exampleData-methodPrecision.csv", target="_blank"),
                                  ...
                                  div(id="stdsol",
                                    ...
                                    h4("Calibration Standard"),
                                    a("Download Example Calibration Standard Structure CSV", href="exampleData/exampleData-calibrationStandard-structure.csv", target="_blank"),
                                    ...
                                    a("Download Example Calibration Standard Equipment CSV", href="exampleData/exampleData-calibrationStandard-equipment.csv", target="_blank"),
                                  ...
                                  div(id="sampleprep",
                                    ...
                                    a("Download Example Sample Preparation CSV", href="exampleData/exampleData-samplepreparation.csv", target="_blank"),
