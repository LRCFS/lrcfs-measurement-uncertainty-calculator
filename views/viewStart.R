                                                            ...
                                                            tabPanel(title="Quadratic Fit",
                                                                     fluidRow(
                                                                       column(width=6,
                                                                              ...
                                                                              a("Download Quadratic Pooled Standard Error CSV", href="exampleData/exampleData-calibrationCurve-quadratic-pooledStandardError.csv", target="_blank", class="exampleDownloadLink"),
                                                                              uiOutput("display_start_calibrationCurveQuadratic_pooledStandardError_FileUpload"),
                                                                              div("Error with uploaded file...", class="error", id="display_start_error_calibrationCurveQuadratic_pooledStandardError_FileUpload"),
