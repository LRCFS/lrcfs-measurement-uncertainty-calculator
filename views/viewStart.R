tabStart = tabItem(tabName = "start",
                   fluidRow(
                     box(title=paste0("Welcome to ",APP_NAME_SHORT), width=12,
                         ...
                         p("Once data is uploaded, a step by step computation and details of all formulas used can be accessed by clicking on the respective uncertainty component tab displayed at the left hand side of the screen. Each uncertainty component tab have three main tabs; Overview, Method and step by step calculation tab, which together give detailed information on the approached used."),
                         hr(),
