...
tabCombinedUncertainty = tabItem(tabName = "combinedUncertainty",
                 ...
                 fluidRow(
                   box(title = "Overview", width=6,
                       ...
                       p("If data is uploaded for all the uncertainty components; Calibration Curve, Method Precision, Standard Solution and Sample Preparation, relative standard uncertainty is computed for each uncertainty component and are combined to obtain the Combined Uncertainty of the analytical process."),
                 ...
                 fluidRow(
                   ...
                   valueBox(uiOutput("display_samplePreparation_finalAnswer_combinedUncertainty"),"\\(u_r\\text{(SamplePreparation)}\\)", width = 4, color = "maroon", icon = icon("flask")),
