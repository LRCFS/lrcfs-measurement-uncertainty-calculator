...
## Homogeneity Test
`r if(!is.na(params$homogeneityTest_fValue_renderer)) paste(params$homogeneityTest_fValue_renderer, "***")`

`r if(!is.na(params$homogeneity_fCritical_renderer)) paste(params$homogeneity_fCritical_renderer, "***")`
...
## Homogeneity
`r if(!is.na(params$homogeneity_standardUncertainty_left_renderer)) paste(params$homogeneity_standardUncertainty_left_renderer, "***")`

`r if(!is.na(params$homogeneity_standardUncertainty_right_renderer)) paste(params$homogeneity_standardUncertainty_right_renderer, "***")`

`r if(!is.na(params$homogeneity_standardUncertainty_max_renderer)) paste(params$homogeneity_standardUncertainty_max_renderer, "***")`
...
`r if(!is.na(params$calibrationCurve_linearRegression_renderer)) paste(params$calibrationCurve_linearRegression_renderer, "***")`
...
## Sample Preparation
`r if(!is.na(params$samplePreparation_standardUncertainty_renderer)) paste(params$samplePreparation_standardUncertainty_renderer, "***")`

`r if(!is.na(params$samplePreparation_relativeStandardUncertainty_renderer)) paste(params$samplePreparation_relativeStandardUncertainty_renderer, "***")`
...
ggplot(data, aes(x = percentage, y = uncertaintyComponent)) +
  geom_col(width = 0.7) + 
