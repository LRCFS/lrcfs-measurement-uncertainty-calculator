...
If data is uploaded for all the uncertainty components; Calibration Curve, Method Precision, Standard Solution and Sample Preparation, relative standard uncertainty is computed for each uncertainty component and are combined to obtain the Combined Uncertainty of the analytical process.
